...
def create_embeddings(data_path,
    ...
    class SentenceGenerator(object):
        ...
        def __iter__(self):
            for chunk in pd.read_csv(self.data_path,usecols=["text"], iterator=True, chunksize=5000, encoding='utf8', engine='python'):
                yield tokenize(chunk.to_string())

    sentences = SentenceGenerator(data_path)
...
if __name__ == '__main__':
    ...
    # data_path = '/Users/yekun/Documents/CODE_/MLP/sentiment analysis/aclImdb/test/neg'
