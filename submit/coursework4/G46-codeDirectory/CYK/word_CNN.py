...
filepath='../../MLP_models/NEW_CBOW_CNN_WORD_3.hdf5'
...
write_filename='NEW_CBOW_CNN_WORD_3.pdf'
save_history(history, 'NEW_CBOW_CNN_WORD_3.csv', subdir='new_EM_TEST')
...
new_model = load_model('../../MLP_models/NEW_CBOW_CNN_WORD_3.hdf5')
