...
print ('###########################################################')
print ('LSTM layer output shape is:',model.output_shape)
...
filepath = os.path.join(best_model_dir, 'CBOW_lstm+cnn_test')
...
write_filename='word_lstm+cnn.pdf'
save_history(history, 'CBOW_lstm+cnn.csv', subdir='LSTM_CNN')
