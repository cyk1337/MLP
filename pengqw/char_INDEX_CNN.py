...
filepath='../../MLP_models/new_newchar_CNN_2_CNNlayer_2DNN_kerastrue_test.hdf5'
...
write_filename='new_newchar_CNN_2_CNNlayer_2DNN_kerastrue_test.pdf'
save_history(history, 'new_newchar_CNN_2_CNNlayer_2DNN_kerastrue_test.csv', subdir='Character_Level_Models_Keras_True')

print ('the process for {} is done'.format(write_filename))

new_model = load_model('../../MLP_models/new_newchar_CNN_2_CNNlayer_2DNN_kerastrue_test.hdf5')
