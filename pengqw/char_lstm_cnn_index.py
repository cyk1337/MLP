...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar 29 00:15:30 2018
...
filepath='../../MLP_models/char_LSTM_CNN_INDEX.hdf5'
...
write_filename='char_LSTM_CNN_INDEX.pdf'
save_history(history, 'char_LSTM_CNN_INDEX.csv', subdir='Character_Level_Models_INDEX')

print ('the process for {} is done'.format(write_filename))

new_model = load_model('../../MLP_models/char_LSTM_CNN_INDEX.hdf5')
